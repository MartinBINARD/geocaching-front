function ProfileAward({ circuits }) {
  return (
    <>
      <h3 className="text-center font-bold text-xl m-4">Circuits accomplis</h3>
      {circuits.map((circuit) => (
        ...
        >
          ...
          <h4 className="collapse-title text-xl font-medium">{circuit.name}</h4>
